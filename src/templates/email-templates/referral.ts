                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="center" class="header-text" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Manrope;font-size:20px;font-weight:500;line-height:29px;text-align:center;color:#08123B;">Join TraderApp Early & Get 90% Off—Unlock Consistent Profits Today! 🚀💰</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:30px;word-break:break-word;">
                                  <div style="font-family:Manrope;font-size:24px;font-weight:800;line-height:1;text-align:left;color:#08123B;">Here's why you should join now 😄</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:30px;word-break:break-word;">
                                  <div style="font-family:Manrope;font-size:24px;font-weight:800;line-height:1;text-align:left;color:#08123B;">Here's how to get started 🤭</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" class="body-text" style="font-size:0px;padding:10px 25px;word-break:break-word;">
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Manrope;font-size:14px;font-weight:600;line-height:1;text-align:center;color:#0A0D14;">Copyright © 2024 TraderApp,<br /> All rights reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
