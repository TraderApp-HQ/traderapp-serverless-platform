...
describe("Create User Wallet Integration Test", () => {
    let walletsService: typeof WalletsService;
    let userWalletCollection: MongoDBClient<IUserWallet>;
    ...
    beforeAll(async () => {
        ...
        userWalletCollection = new MongoDBClient<IUserWallet>(
            connection,
        ...
        const queueMessages = [
            {
                ...
                eventSource: "aws:sqs",
                eventSourceARN:
                    "arn:aws:sqs:eu-west-1:575439814610:dev-createUserWalletQueue",
                awsRegion: "eu-west-1",
            },
        ];
