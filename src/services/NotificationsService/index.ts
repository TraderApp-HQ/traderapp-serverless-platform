...
export class NotificationsService {
  ...
  public async processMessagesAndSendEmails(queueMessages: IQueueEmailMessageBody[]): Promise<void> {
  ...
  public async sendBulkEmailWithSendpulse(queueMessages: IQueueEmailMessageBody[]): Promise<void> {
    // const sendpulseEmailService = await SendpulseEmailService.create();
