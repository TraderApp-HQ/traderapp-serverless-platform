...
const handler = async (event) => {
    lambda_powertools_logger_1.default.info("Handler for user wallet creation");
    ...
    const { failedMessageIds } = await WalletsService_1.default.createUserWallet(queueMessages);
    return {
