...
var send_email_otp_exports = {};
__export(send_email_otp_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(send_email_otp_exports);
...
var handler = async (event) => {
  ...
  await notificationService.processMessagesAndSendEmail(queueMessages);
};
