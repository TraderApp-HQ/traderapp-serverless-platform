...
var require_dist_cjs17 = __commonJS({
  "node_modules/@smithy/smithy-client/dist-cjs/index.js"(exports2, module2) {
    ...
    var Client = _Client;
    var import_util_stream = require_dist_cjs16();
...
var require_dist_cjs18 = __commonJS({
  "node_modules/@aws-sdk/middleware-sdk-sqs/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_smithy_client5 = require_dist_cjs17();
...
var require_dist_cjs26 = __commonJS({
  "node_modules/@smithy/middleware-endpoint/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_middleware_serde2 = require_dist_cjs25();
...
var init_getHttpAuthSchemeEndpointRuleSetPlugin = __esm({
  "node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemeEndpointRuleSetPlugin.js"() {
    import_middleware_endpoint = __toESM(require_dist_cjs26());
...
var init_getHttpAuthSchemePlugin = __esm({
  "node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemePlugin.js"() {
    import_middleware_serde = __toESM(require_dist_cjs25());
    init_httpAuthSchemeMiddleware();
...
var init_getHttpSigningMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/middleware-http-signing/getHttpSigningMiddleware.js"() {
    import_middleware_retry = __toESM(require_dist_cjs29());
...
var init_resolveAwsSdkSigV4Config = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4Config.js"() {
    init_client();
    init_dist_es();
    import_signature_v4 = __toESM(require_dist_cjs32());
...
var require_dist_cjs45 = __commonJS({
  "node_modules/@aws-sdk/client-sso/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_middleware_endpoint2 = require_dist_cjs26();
    var import_middleware_retry2 = require_dist_cjs29();
...
var require_dist_cjs54 = __commonJS({
  "node_modules/@aws-sdk/client-sqs/dist-cjs/index.js"(exports2, module2) {
    ...
    var DeleteMessageBatchCommand2 = _DeleteMessageBatchCommand;
...
__export(sqs_exports, {
  deleteSqsMessagesBatch: () => deleteSqsMessagesBatch
});
module.exports = __toCommonJS(sqs_exports);
var import_client_sqs = __toESM(require_dist_cjs54());
async function deleteSqsMessagesBatch(queueUrl, records, messageIds, sqsClient = new import_client_sqs.SQSClient({})) {
  const idToReceipt = {};
  records.forEach((record) => {
    idToReceipt[record.messageId] = record.receiptHandle;
  });
  for (let i = 0; i < messageIds.length; i += 10) {
    const batch = messageIds.slice(i, i + 10);
    const entries = batch.map((id) => ({
      Id: id,
      ReceiptHandle: idToReceipt[id]
    })).filter((entry) => !!entry.ReceiptHandle);
    ...
    try {
      const result = await sqsClient.send(
        new import_client_sqs.DeleteMessageBatchCommand(deleteParams)
      );
      if (result.Failed && result.Failed.length > 0) {
        console.log("Some messages failed to delete:", result.Failed);
      }
    } catch (err) {
      console.log("Failed to delete messages from SQS:", err);
    }
  }
}
