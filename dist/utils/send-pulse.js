...
var require_sendpulse = __commonJS({
  "node_modules/sendpulse-api/api/sendpulse.js"(exports2) {
    ...
    function md5(data2) {
      var md5sum = crypto2.createHash("md5");
      md5sum.update(data2);
      return md5sum.digest("hex");
    }
    function base64(data2) {
      var b3 = new Buffer(data2);
      return b3.toString("base64");
    }
    function mkdirSyncRecursive(directory) {
      var path = directory.replace(/\/$/, "").split("/");
      for (var i3 = 1; i3 <= path.length; i3++) {
        var segment = path.slice(0, i3).join("/");
    ...
    function sendRequest(path, method, data2, useToken, callback) {
      var headers = {};
      headers["Content-Type"] = "application/json";
      headers["Content-Length"] = Buffer.byteLength(JSON.stringify(data2));
          ...
          response.on("end", function() {
            ...
            if (response.statusCode === 401) {
              ...
              getToken(function(result) {
                ...
                sendRequest(path, method, data2, true, callback);
              });
              return;
            }
            callback(answer);
      ...
      req.on("error", function(error2) {
        if (error2.message !== void 0) {
          var answer = returnError(error2.message, error2.errno);
        } else {
          var answer = returnError(error2.code, error2.errno);
        }
        callback(answer);
      });
      req.end();
    ...
    function getToken(callback) {
      ...
      sendRequest("oauth/access_token", "POST", data2, false, saveToken);
      function saveToken(data3) {
        if (data3 && data3.is_error) {
          callback(data3);
          return;
        }
      ...
      var val, key, okey, ktype = "", vals = "", count = 0, _utf8Size = function(str) {
        ...
        for (i3 = 0; i3 < l3; i3++) {
          ...
          if (code < 128) {
            ...
            var lo = str.charCodeAt(++i3);
            if (i3 < l3 && lo >= 56320 && lo <= 57343) {
              size += 4;
            } else {
              size = 0;
            }
    ...
    function listAddressBooks(callback, limit, offset) {
      ...
      sendRequest("addressbooks", "GET", data2, true, callback);
    }
    function createAddressBook(callback, bookName) {
      ...
      var data2 = { bookName };
      sendRequest("addressbooks", "POST", data2, true, callback);
    }
    function editAddressBook(callback, id, bookName) {
      ...
      var data2 = { name: bookName };
      sendRequest("addressbooks/" + id, "PUT", data2, true, callback);
    }
    ...
    function addEmails(callback, id, emails) {
      ...
      var data2 = { emails: serialize(emails) };
      sendRequest("addressbooks/" + id + "/emails", "POST", data2, true, callback);
    }
    function removeEmails(callback, id, emails) {
      ...
      var data2 = { emails: serialize(emails) };
      sendRequest("addressbooks/" + id + "/emails", "DELETE", data2, true, callback);
    }
    ...
    function updateEmailVariables(callback, id, email, variables) {
      ...
      sendRequest("addressbooks/" + id + "/emails/variable", "POST", data2, true, callback);
    }
    ...
    function listCampaigns(callback, limit, offset) {
      ...
      sendRequest("campaigns", "GET", data2, true, callback);
    }
    ...
    function createCampaign(callback, senderName, senderEmail, subject, body, bookId, name, attachments) {
      ...
      sendRequest("campaigns", "POST", data2, true, callback);
    }
    ...
    function addSender(callback, senderName, senderEmail) {
      ...
      sendRequest("senders", "POST", data2, true, callback);
    }
    function removeSender(callback, senderEmail) {
      ...
      sendRequest("senders", "DELETE", data2, true, callback);
    }
    function activateSender(callback, senderEmail, code) {
      ...
      sendRequest("senders/" + senderEmail + "/code", "POST", data2, true, callback);
    }
    ...
    function addToBlackList(callback, emails, comment) {
      ...
      sendRequest("blacklist", "POST", data2, true, callback);
    }
    function removeFromBlackList(callback, emails) {
      ...
      sendRequest("blacklist", "DELETE", data2, true, callback);
    }
    ...
    function smtpListEmails(callback, limit, offset, fromDate, toDate, sender, recipient) {
      ...
      sendRequest("smtp/emails", "GET", data2, true, callback);
    }
    ...
    function smtpUnsubscribeEmails(callback, emails) {
      ...
      sendRequest("smtp/unsubscribe", "POST", data2, true, callback);
    }
    function smtpRemoveFromUnsubscribe(callback, emails) {
      ...
      sendRequest("smtp/unsubscribe", "DELETE", data2, true, callback);
    }
    ...
    function smtpAddDomain(callback, email) {
      ...
      sendRequest("smtp/domains", "POST", data2, true, callback);
    }
    ...
    function smtpSendMail(callback, email) {
      ...
      sendRequest("smtp/emails", "POST", data2, true, callback);
    }
    function smsAddPhones(callback, addressbook_id, phones) {
      ...
      sendRequest("sms/numbers", "POST", data2, true, callback);
    }
    function smsAddPhonesWithVariables(callback, addressbook_id, phones) {
      ...
      sendRequest("sms/numbers/variables", "POST", data2, true, callback);
    }
    function smsRemovePhones(callback, addressbook_id, phones) {
      ...
      sendRequest("sms/numbers", "DELETE", data2, true, callback);
    }
    ...
    function smsUpdatePhonesVariables(callback, addressbook_id, phones, variables) {
      ...
      sendRequest("sms/numbers", "PUT", data2, true, callback);
    }
    function smsGetPhonesInfoFromBlacklist(callback, phones) {
      ...
      sendRequest("sms/black_list/by_numbers", "GET", data2, true, callback);
    }
    function smsAddPhonesToBlacklist(callback, phones, comment) {
      ...
      sendRequest("sms/black_list", "POST", data2, true, callback);
    }
    function smsDeletePhonesFromBlacklist(callback, phones) {
      ...
      sendRequest("sms/black_list", "DELETE", data2, true, callback);
    }
    function smsAddCampaign(callback, sender_name, addressbook_id, body, date2, transliterate) {
      ...
      sendRequest("sms/campaigns", "POST", data2, true, callback);
    }
    function smsSend(callback, sender_name, phones, body, date2, transliterate, route) {
      if (sender_name === void 0) {
        return callback(returnError("Empty sender name"));
      }
      if (phones === void 0 || !phones.length) {
      ...
      sendRequest("sms/send", "POST", data2, true, callback);
    }
    function smsGetListCampaigns(callback, date_from, date_to) {
      ...
      sendRequest("sms/campaigns/list", "GET", data2, true, callback);
    }
    ...
    function smsGetCampaignCost(callback, sender_name, body, addressbook_id, phones) {
      ...
      if (phones.length) {
        data2["phones"] = JSON.stringify(phones);
      }
      sendRequest("sms/campaigns/cost", "GET", data2, true, callback);
    }
    function smsDeleteCampaign(callback, campaign_id) {
      ...
      sendRequest("sms/campaigns", "DELETE", data2, true, callback);
    }
    function sendRowRequest(path, method, data2, callback) {
      if (data2 === void 0) {
        data2 = {};
      }
      if (!callback) {
...
var require_dist_cjs53 = __commonJS({
  "node_modules/@aws-sdk/client-secrets-manager/dist-cjs/index.js"(exports2) {
    ...
    var SecretsManagerClient2 = class extends smithyClient.Client {
      constructor(...[configuration]) {
        const _config_0 = runtimeConfig.getRuntimeConfig(configuration || {});
        super(_config_0);
        __publicField(this, "config");
    ...
    var SecretsManagerServiceException = class _SecretsManagerServiceException extends smithyClient.ServiceException {
      constructor(options) {
        super(options);
    ...
    var se_DeleteSecretCommand = async (input, context) => {
      const headers = sharedHeaders("DeleteSecret");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_DescribeSecretCommand = async (input, context) => {
      const headers = sharedHeaders("DescribeSecret");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_GetRandomPasswordCommand = async (input, context) => {
    ...
    var se_GetSecretValueCommand = async (input, context) => {
      const headers = sharedHeaders("GetSecretValue");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_ListSecretsCommand = async (input, context) => {
      const headers = sharedHeaders("ListSecrets");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_ListSecretVersionIdsCommand = async (input, context) => {
    ...
    var se_UpdateSecretCommand = async (input, context) => {
      const headers = sharedHeaders("UpdateSecret");
      let body;
      body = JSON.stringify(se_UpdateSecretRequest(input, context));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_UpdateSecretVersionStageCommand = async (input, context) => {
      const headers = sharedHeaders("UpdateSecretVersionStage");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var se_ValidateResourcePolicyCommand = async (input, context) => {
      const headers = sharedHeaders("ValidateResourcePolicy");
      let body;
      body = JSON.stringify(smithyClient._json(input));
      return buildHttpRpcRequest2(context, headers, "/", void 0, body);
    };
    var de_BatchGetSecretValueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_BatchGetSecretValueResponse(data2, context);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_CancelRotateSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_CreateSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_CreateSecretResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_DeleteSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_DeleteSecretResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_DescribeSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_DescribeSecretResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_GetRandomPasswordCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_GetSecretValueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_GetSecretValueResponse(data2, context);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_ListSecretsCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_ListSecretsResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_ListSecretVersionIdsCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_ListSecretVersionIdsResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_PutSecretValueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_RemoveRegionsFromReplicationCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_RemoveRegionsFromReplicationResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_ReplicateSecretToRegionsCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
      let contents = {};
      contents = de_ReplicateSecretToRegionsResponse(data2);
      const response = {
        $metadata: deserializeMetadata3(output),
        ...contents
      };
    ...
    var de_RestoreSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_RotateSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_StopReplicationToReplicaCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_UpdateSecretCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_UpdateSecretVersionStageCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_ValidateResourcePolicyCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_CommandError3 = async (output, context) => {
      ...
      switch (errorCode) {
        ...
        case "com.amazonaws.secretsmanager#MalformedPolicyDocumentException":
          throw await de_MalformedPolicyDocumentExceptionRes2(parsedOutput);
    ...
    var de_DecryptionFailureRes = async (parsedOutput, context) => {
      const body = parsedOutput.body;
    ...
    var de_EncryptionFailureRes = async (parsedOutput, context) => {
      const body = parsedOutput.body;
      const deserialized = smithyClient._json(body);
    ...
    var de_InternalServiceErrorRes = async (parsedOutput, context) => {
      const body = parsedOutput.body;
      const deserialized = smithyClient._json(body);
    ...
    var de_PublicPolicyExceptionRes = async (parsedOutput, context) => {
      const body = parsedOutput.body;
      const deserialized = smithyClient._json(body);
    ...
    var de_ResourceExistsExceptionRes = async (parsedOutput, context) => {
      const body = parsedOutput.body;
      const deserialized = smithyClient._json(body);
    ...
    var se_CreateSecretRequest = (input, context) => {
    ...
    var se_PutSecretValueRequest = (input, context) => {
      return smithyClient.take(input, {
        ClientRequestToken: [true, (_2) => _2 ?? uuid.v4()],
        RotationToken: [],
        SecretBinary: context.base64Encoder,
    ...
    var se_RotateSecretRequest = (input, context) => {
      return smithyClient.take(input, {
        ClientRequestToken: [true, (_2) => _2 ?? uuid.v4()],
        RotateImmediately: [],
        RotationLambdaARN: [],
    ...
    var se_UpdateSecretRequest = (input, context) => {
      return smithyClient.take(input, {
        ClientRequestToken: [true, (_2) => _2 ?? uuid.v4()],
        Description: [],
        KmsKeyId: [],
    ...
    var de_BatchGetSecretValueResponse = (output, context) => {
      return smithyClient.take(output, {
        Errors: smithyClient._json,
        NextToken: smithyClient.expectString,
        SecretValues: (_2) => de_SecretValuesType(_2, context)
      });
    };
    var de_CreateSecretResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        Name: smithyClient.expectString,
        ReplicationStatus: (_2) => de_ReplicationStatusListType(_2),
        VersionId: smithyClient.expectString
      });
    };
    var de_DeleteSecretResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        DeletionDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        Name: smithyClient.expectString
      });
    };
    var de_DescribeSecretResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        CreatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        DeletedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        Description: smithyClient.expectString,
        KmsKeyId: smithyClient.expectString,
        LastAccessedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        LastChangedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        LastRotatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        Name: smithyClient.expectString,
        NextRotationDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
    ...
    var de_GetSecretValueResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        CreatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        Name: smithyClient.expectString,
    ...
    var de_ListSecretsResponse = (output, context) => {
      return smithyClient.take(output, {
        NextToken: smithyClient.expectString,
        SecretList: (_2) => de_SecretListType(_2)
      });
    };
    var de_ListSecretVersionIdsResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        Name: smithyClient.expectString,
        NextToken: smithyClient.expectString,
        Versions: (_2) => de_SecretVersionsListType(_2)
      });
    };
    var de_RemoveRegionsFromReplicationResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        ReplicationStatus: (_2) => de_ReplicationStatusListType(_2)
      });
    };
    var de_ReplicateSecretToRegionsResponse = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        ReplicationStatus: (_2) => de_ReplicationStatusListType(_2)
      });
    };
    var de_ReplicationStatusListType = (output, context) => {
      const retVal = (output || []).filter((e3) => e3 != null).map((entry) => {
        return de_ReplicationStatusType(entry);
      });
      return retVal;
    };
    var de_ReplicationStatusType = (output, context) => {
      return smithyClient.take(output, {
        KmsKeyId: smithyClient.expectString,
        LastAccessedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
    ...
    var de_SecretListEntry = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        CreatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        DeletedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
    ...
    var de_SecretListType = (output, context) => {
      const retVal = (output || []).filter((e3) => e3 != null).map((entry) => {
        return de_SecretListEntry(entry);
      });
      return retVal;
    };
    var de_SecretValueEntry = (output, context) => {
      return smithyClient.take(output, {
        ARN: smithyClient.expectString,
        CreatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
        Name: smithyClient.expectString,
    ...
    var de_SecretValuesType = (output, context) => {
      const retVal = (output || []).filter((e3) => e3 != null).map((entry) => {
        return de_SecretValueEntry(entry, context);
      });
      return retVal;
    };
    var de_SecretVersionsListEntry = (output, context) => {
      return smithyClient.take(output, {
        CreatedDate: (_2) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_2))),
    ...
    var de_SecretVersionsListType = (output, context) => {
      const retVal = (output || []).filter((e3) => e3 != null).map((entry) => {
    ...
    var throwDefaultError3 = smithyClient.withBaseException(SecretsManagerServiceException);
    ...
    function sharedHeaders(operation2) {
      return {
        ...
        "x-amz-target": `secretsmanager.${operation2}`
      };
    }
    var BatchGetSecretValueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var CancelRotateSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var CreateSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DeleteResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DeleteSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DescribeSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var GetRandomPasswordCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var GetResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var GetSecretValueCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListSecretsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListSecretVersionIdsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var PutResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var PutSecretValueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var RemoveRegionsFromReplicationCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ReplicateSecretToRegionsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var RestoreSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var RotateSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var StopReplicationToReplicaCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var UpdateSecretCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var UpdateSecretVersionStageCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ValidateResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    smithyClient.createAggregatedClient(commands3, SecretsManager);
    var paginateBatchGetSecretValue = core.createPaginator(SecretsManagerClient2, BatchGetSecretValueCommand, "NextToken", "NextToken", "MaxResults");
    var paginateListSecretVersionIds = core.createPaginator(SecretsManagerClient2, ListSecretVersionIdsCommand, "NextToken", "NextToken", "MaxResults");
    var paginateListSecrets = core.createPaginator(SecretsManagerClient2, ListSecretsCommand, "NextToken", "NextToken", "MaxResults");
    Object.defineProperty(exports2, "$Command", {
      enumerable: true,
      get: function() {
        return smithyClient.Command;
    ...
    exports2.BatchGetSecretValueResponseFilterSensitiveLog = BatchGetSecretValueResponseFilterSensitiveLog;
    exports2.CancelRotateSecretCommand = CancelRotateSecretCommand;
    exports2.CreateSecretCommand = CreateSecretCommand;
    exports2.CreateSecretRequestFilterSensitiveLog = CreateSecretRequestFilterSensitiveLog;
    ...
    exports2.GetRandomPasswordResponseFilterSensitiveLog = GetRandomPasswordResponseFilterSensitiveLog;
    exports2.GetResourcePolicyCommand = GetResourcePolicyCommand;
    exports2.GetSecretValueCommand = GetSecretValueCommand2;
    exports2.GetSecretValueResponseFilterSensitiveLog = GetSecretValueResponseFilterSensitiveLog;
    ...
    exports2.PutSecretValueRequestFilterSensitiveLog = PutSecretValueRequestFilterSensitiveLog;
    ...
    exports2.SecretValueEntryFilterSensitiveLog = SecretValueEntryFilterSensitiveLog;
    exports2.SecretsManager = SecretsManager;
    exports2.SecretsManagerClient = SecretsManagerClient2;
    ...
    exports2.UpdateSecretRequestFilterSensitiveLog = UpdateSecretRequestFilterSensitiveLog;
...
var SendpulseEmailService = class _SendpulseEmailService {
  ...
  async sendEmail({
    ...
    return new Promise((resolve, reject) => {
      import_sendpulse_api.default.smtpSendMail((data2) => {
