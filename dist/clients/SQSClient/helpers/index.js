...
var init_CreateTokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/commands/CreateTokenCommand.js"() {
    ...
    import_middleware_serde2 = __toESM(require_dist_cjs21());
...
var init_AssumeRoleCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleCommand.js"() {
    ...
    import_middleware_serde3 = __toESM(require_dist_cjs21());
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleWithWebIdentityCommand.js"() {
    ...
    import_middleware_serde4 = __toESM(require_dist_cjs21());
...
var require_dist_cjs52 = __commonJS({
  "node_modules/@aws-sdk/credential-provider-ini/dist-cjs/index.js"(exports2) {
    ...
    var resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => __toESM(require_dist_cjs51())).then(({ fromTokenFile }) => fromTokenFile({
...
var require_ruleset2 = __commonJS({
  "node_modules/@aws-sdk/client-sqs/dist-cjs/endpoint/ruleset.js"(exports2) {
    ...
    var s3 = [m3];
    var t3 = [{ [x3]: "Region" }];
    var _data3 = { version: "1.0", parameters: { Region: i3, UseDualStack: j3, UseFIPS: j3, Endpoint: i3 }, rules: [{ conditions: [{ [v3]: b3, [w3]: [k3] }], rules: [{ conditions: r3, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d3 }, { conditions: s3, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d3 }, { endpoint: { url: k3, properties: n3, headers: n3 }, type: e3 }], type: f3 }, { conditions: [{ [v3]: b3, [w3]: t3 }], rules: [{ conditions: [{ [v3]: "aws.partition", [w3]: t3, assign: g3 }], rules: [{ conditions: [l3, m3], rules: [{ conditions: [{ [v3]: c3, [w3]: [a3, o3] }, q3], rules: [{ endpoint: { url: "https://sqs-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: n3, headers: n3 }, type: e3 }], type: f3 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d3 }], type: f3 }, { conditions: r3, rules: [{ conditions: [{ [v3]: c3, [w3]: [o3, a3] }], rules: [{ conditions: [{ [v3]: "stringEquals", [w3]: [{ [v3]: h3, [w3]: [p3, "name"] }, "aws-us-gov"] }], endpoint: { url: "https://sqs.{Region}.amazonaws.com", properties: n3, headers: n3 }, type: e3 }, { endpoint: { url: "https://sqs-fips.{Region}.{PartitionResult#dnsSuffix}", properties: n3, headers: n3 }, type: e3 }], type: f3 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d3 }], type: f3 }, { conditions: s3, rules: [{ conditions: [q3], rules: [{ endpoint: { url: "https://sqs.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: n3, headers: n3 }, type: e3 }], type: f3 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d3 }], type: f3 }, { endpoint: { url: "https://sqs.{Region}.{PartitionResult#dnsSuffix}", properties: n3, headers: n3 }, type: e3 }], type: f3 }], type: f3 }, { error: "Invalid Configuration: Missing Region", type: d3 }] };
    exports2.ruleSet = _data3;
  }
});
  ...
  "node_modules/@aws-sdk/client-sqs/dist-cjs/index.js"(exports2) {
    ...
    var InvalidAddress = class _InvalidAddress extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidAddress");
        __publicField(this, "$fault", "client");
    ...
    var InvalidSecurity = class _InvalidSecurity extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidSecurity");
        __publicField(this, "$fault", "client");
    ...
    var OverLimit = class _OverLimit extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "OverLimit");
        __publicField(this, "$fault", "client");
    ...
    var QueueDoesNotExist = class _QueueDoesNotExist extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "QueueDoesNotExist");
        __publicField(this, "$fault", "client");
    ...
    var RequestThrottled = class _RequestThrottled extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "RequestThrottled");
        __publicField(this, "$fault", "client");
    ...
    var MessageNotInflight = class _MessageNotInflight extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "MessageNotInflight");
        __publicField(this, "$fault", "client");
    ...
    var ReceiptHandleIsInvalid = class _ReceiptHandleIsInvalid extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "ReceiptHandleIsInvalid");
        __publicField(this, "$fault", "client");
    ...
    var BatchEntryIdsNotDistinct = class _BatchEntryIdsNotDistinct extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "BatchEntryIdsNotDistinct");
        __publicField(this, "$fault", "client");
    ...
    var EmptyBatchRequest = class _EmptyBatchRequest extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "EmptyBatchRequest");
        __publicField(this, "$fault", "client");
    ...
    var InvalidBatchEntryId = class _InvalidBatchEntryId extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidBatchEntryId");
        __publicField(this, "$fault", "client");
    ...
    var TooManyEntriesInBatchRequest = class _TooManyEntriesInBatchRequest extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "TooManyEntriesInBatchRequest");
        __publicField(this, "$fault", "client");
    ...
    var InvalidAttributeName = class _InvalidAttributeName extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidAttributeName");
        __publicField(this, "$fault", "client");
    ...
    var InvalidAttributeValue = class _InvalidAttributeValue extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidAttributeValue");
        __publicField(this, "$fault", "client");
    ...
    var QueueDeletedRecently = class _QueueDeletedRecently extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "QueueDeletedRecently");
        __publicField(this, "$fault", "client");
    ...
    var QueueNameExists = class _QueueNameExists extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "QueueNameExists");
        __publicField(this, "$fault", "client");
    ...
    var InvalidIdFormat = class _InvalidIdFormat extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidIdFormat");
        __publicField(this, "$fault", "client");
    ...
    var PurgeQueueInProgress = class _PurgeQueueInProgress extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "PurgeQueueInProgress");
        __publicField(this, "$fault", "client");
    ...
    var KmsAccessDenied = class _KmsAccessDenied extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsAccessDenied");
        __publicField(this, "$fault", "client");
    ...
    var KmsDisabled = class _KmsDisabled extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsDisabled");
        __publicField(this, "$fault", "client");
    ...
    var KmsInvalidKeyUsage = class _KmsInvalidKeyUsage extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsInvalidKeyUsage");
        __publicField(this, "$fault", "client");
    ...
    var KmsInvalidState = class _KmsInvalidState extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsInvalidState");
        __publicField(this, "$fault", "client");
    ...
    var KmsNotFound = class _KmsNotFound extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsNotFound");
        __publicField(this, "$fault", "client");
    ...
    var KmsOptInRequired = class _KmsOptInRequired extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsOptInRequired");
        __publicField(this, "$fault", "client");
    ...
    var KmsThrottled = class _KmsThrottled extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "KmsThrottled");
        __publicField(this, "$fault", "client");
    ...
    var InvalidMessageContents = class _InvalidMessageContents extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "InvalidMessageContents");
        __publicField(this, "$fault", "client");
    ...
    var BatchRequestTooLong = class _BatchRequestTooLong extends SQSServiceException {
      constructor(opts) {
        ...
        __publicField(this, "name", "BatchRequestTooLong");
        __publicField(this, "$fault", "client");
    ...
    var de_CancelMessageMoveTaskCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
    ...
    var de_ChangeMessageVisibilityCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var de_ChangeMessageVisibilityBatchCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_CreateQueueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_DeleteMessageBatchCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_DeleteQueueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var de_GetQueueAttributesCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_GetQueueUrlCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_ListDeadLetterSourceQueuesCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_ListMessageMoveTasksCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_ListQueuesCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_ListQueueTagsCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_PurgeQueueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var de_ReceiveMessageCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_SendMessageCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_SendMessageBatchCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_SetQueueAttributesCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var de_StartMessageMoveTaskCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      const data2 = await core$1.parseJsonBody(output.body, context);
    ...
    var de_TagQueueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var de_UntagQueueCommand = async (output, context) => {
      if (output.statusCode >= 300) {
        return de_CommandError3(output, context);
      }
      await smithyClient.collectBody(output.body, context);
    ...
    var se_ActionNameList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return core$1._toStr(entry);
      });
    };
    var se_AddPermissionRequest = (input, context) => {
      return smithyClient.take(input, {
        AWSAccountIds: (_2) => se_AWSAccountIdList(_2),
        Actions: (_2) => se_ActionNameList(_2),
        Label: core$1._toStr,
    ...
    var se_AWSAccountIdList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return core$1._toStr(entry);
      });
    };
    ...
    var se_CancelMessageMoveTaskRequest = (input, context) => {
      return smithyClient.take(input, {
        TaskHandle: core$1._toStr
      });
    };
    var se_ChangeMessageVisibilityBatchRequest = (input, context) => {
      return smithyClient.take(input, {
        Entries: (_2) => se_ChangeMessageVisibilityBatchRequestEntryList(_2),
        QueueUrl: core$1._toStr
      });
    };
    var se_ChangeMessageVisibilityBatchRequestEntry = (input, context) => {
      return smithyClient.take(input, {
        Id: core$1._toStr,
    ...
    var se_ChangeMessageVisibilityBatchRequestEntryList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return se_ChangeMessageVisibilityBatchRequestEntry(entry);
      });
    };
    var se_ChangeMessageVisibilityRequest = (input, context) => {
      return smithyClient.take(input, {
        QueueUrl: core$1._toStr,
        ReceiptHandle: core$1._toStr,
        VisibilityTimeout: core$1._toNum
    ...
    var se_CreateQueueRequest = (input, context) => {
      return smithyClient.take(input, {
        Attributes: (_2) => se_QueueAttributeMap(_2),
        QueueName: core$1._toStr,
        tags: (_2) => se_TagMap(_2)
      });
    };
    var se_DeleteMessageBatchRequest = (input, context) => {
      return smithyClient.take(input, {
        Entries: (_2) => se_DeleteMessageBatchRequestEntryList(_2),
        QueueUrl: core$1._toStr
      });
    };
    var se_DeleteMessageBatchRequestEntry = (input, context) => {
      return smithyClient.take(input, {
        Id: core$1._toStr,
        ReceiptHandle: core$1._toStr
      });
    };
    var se_DeleteMessageBatchRequestEntryList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
    ...
    var se_GetQueueAttributesRequest = (input, context) => {
      return smithyClient.take(input, {
        AttributeNames: (_2) => se_AttributeNameList(_2),
        QueueUrl: core$1._toStr
      });
    };
    ...
    var se_ListDeadLetterSourceQueuesRequest = (input, context) => {
      return smithyClient.take(input, {
    ...
    var se_ListMessageMoveTasksRequest = (input, context) => {
      return smithyClient.take(input, {
        MaxResults: core$1._toNum,
    ...
    var se_ListQueueTagsRequest = (input, context) => {
      return smithyClient.take(input, {
        QueueUrl: core$1._toStr
      });
    };
    var se_MessageAttributeNameList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return core$1._toStr(entry);
      });
    };
    var se_MessageAttributeValue = (input, context) => {
      return smithyClient.take(input, {
        ...
        StringListValues: (_2) => se_StringList(_2),
    ...
    var se_MessageSystemAttributeList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return core$1._toStr(entry);
      });
    };
    ...
    var se_ReceiveMessageRequest = (input, context) => {
      return smithyClient.take(input, {
        AttributeNames: (_2) => se_AttributeNameList(_2),
        MaxNumberOfMessages: core$1._toNum,
        MessageAttributeNames: (_2) => se_MessageAttributeNameList(_2),
        MessageSystemAttributeNames: (_2) => se_MessageSystemAttributeList(_2),
        QueueUrl: core$1._toStr,
    ...
    var se_RemovePermissionRequest = (input, context) => {
      return smithyClient.take(input, {
        Label: core$1._toStr,
        QueueUrl: core$1._toStr
      });
    };
    var se_SendMessageBatchRequest = (input, context) => {
      return smithyClient.take(input, {
        Entries: (_2) => se_SendMessageBatchRequestEntryList(_2, context),
        QueueUrl: core$1._toStr
      });
    };
    var se_SendMessageBatchRequestEntry = (input, context) => {
      return smithyClient.take(input, {
    ...
    var se_SendMessageBatchRequestEntryList = (input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
    ...
    var se_SetQueueAttributesRequest = (input, context) => {
      return smithyClient.take(input, {
        Attributes: (_2) => se_QueueAttributeMap(_2),
        QueueUrl: core$1._toStr
      });
    };
    var se_StartMessageMoveTaskRequest = (input, context) => {
      return smithyClient.take(input, {
    ...
    var se_TagQueueRequest = (input, context) => {
      return smithyClient.take(input, {
        QueueUrl: core$1._toStr,
        Tags: (_2) => se_TagMap(_2)
      });
    };
    var se_UntagQueueRequest = (input, context) => {
      return smithyClient.take(input, {
        QueueUrl: core$1._toStr,
        TagKeys: (_2) => se_TagKeyList(_2)
      });
    };
    var de_BinaryList = (output, context) => {
    ...
    var de_MessageAttributeValue = (output, context) => {
      return smithyClient.take(output, {
    ...
    var de_MessageBodyAttributeMap = (output, context) => {
    ...
    var de_MessageList = (output, context) => {
      const retVal = (output || []).filter((e3) => e3 != null).map((entry) => {
        return de_Message(entry, context);
      });
      return retVal;
    };
    var de_ReceiveMessageResult = (output, context) => {
      return smithyClient.take(output, {
    ...
    var throwDefaultError3 = smithyClient.withBaseException(SQSServiceException);
    ...
    function sharedHeaders(operation2) {
      return {
        ...
        "x-amz-target": `AmazonSQS.${operation2}`,
    ...
    var AddPermissionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var CancelMessageMoveTaskCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ChangeMessageVisibilityBatchCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ChangeMessageVisibilityCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var CreateQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DeleteMessageBatchCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DeleteMessageCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var DeleteQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var GetQueueAttributesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var GetQueueUrlCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListDeadLetterSourceQueuesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListMessageMoveTasksCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListQueuesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ListQueueTagsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var PurgeQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var ReceiveMessageCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
    ...
    var RemovePermissionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var SendMessageBatchCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
    ...
    var SendMessageCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions()),
    ...
    var SetQueueAttributesCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var StartMessageMoveTaskCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var TagQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var UntagQueueCommand = class extends smithyClient.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        middlewareSerde.getSerdePlugin(config, this.serialize, this.deserialize),
        middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var commands3 = {
      ...
      DeleteMessageBatchCommand: DeleteMessageBatchCommand2,
      DeleteQueueCommand,
    ...
    smithyClient.createAggregatedClient(commands3, SQS);
    ...
    exports2.DeleteMessageBatchCommand = DeleteMessageBatchCommand2;
    exports2.DeleteMessageCommand = DeleteMessageCommand;
    ...
    exports2.SendMessageCommand = SendMessageCommand2;
...
// src/clients/SQSClient/helpers/index.ts
var helpers_exports = {};
...
// src/clients/SQSClient/index.ts
var import_client_sqs = __toESM(require_dist_cjs54());
var QueueService = class {
  constructor(input) {
    this.sqsClient = new import_client_sqs.SQSClient({ region: input.region });
  ...
  async receiveMessages(input) {
    ...
    try {
      ...
      console.error("Error receiving messages:", error2);
      throw error2;
    }
  }
  async deleteMessages(messages) {
    ...
    const command = new import_client_sqs.DeleteMessageBatchCommand({
      QueueUrl: this.queueUrl,
      Entries: entries
    });
    try {
      ...
      console.error("Error deleting messages:", error2);
      throw error2;
    }
  }
};
...
// src/clients/SQSClient/helpers/index.ts
var publishMessageToQueue = async ({
  message,
  queueUrl,
  awsRegion
}) => {
  ...
  try {
    ...
    console.error("Error sending message to queue", { error: error2 });
    throw error2;
  }
};
