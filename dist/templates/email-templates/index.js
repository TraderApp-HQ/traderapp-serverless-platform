...
// src/templates/email-templates/index.ts
var email_templates_exports = {};
__export(email_templates_exports, {
  CreateUserTemplate: () => create_user_template_default,
  GeneralTemplate: () => general_default,
  GetStartedTemplate: () => get_started_template_default,
  OtpTemplate: () => otp_default,
  PasswordResetTemplate: () => password_reseet_template_default,
  ReferralTemplate: () => referral_default,
  SendEmailTemplate: () => send_email_notifications_template_default,
  TransactionNotificationTemplate: () => transaction_notification_template_default
});
